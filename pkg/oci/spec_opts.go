...
// openUserFile opens a user-database file (etc/passwd, etc/group) from the
// given root filesystem. The returned file rejects non-regular sources and
// returns an error if more than maxUserFileBytes are read from it.
